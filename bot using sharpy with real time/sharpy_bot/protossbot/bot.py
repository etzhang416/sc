...
class ProtossBot(KnowledgeBot):
    ...
    def pvp_create_common_strategy(self) -> SequentialList:
        ...
        return SequentialList(
            ...
            PlanZoneGather(),
            OracleHarass(),
            DoubleAdeptScout(adepts_to_start=2),
            PlanZoneDefense(),
            PlanZoneAttack(),
            PlanFinishEnemy()
        )
    ...
    def pvz_create_common_strategy(self) -> SequentialList:
        ...
        return SequentialList(
            ...
            WorkerRallyPoint(),
            PlanZoneGather(),
            DoubleAdeptScout(adepts_to_start=3),
            OracleHarass(),
            PlanZoneDefense(),
    ...
    def pvp_micro_build(self) -> BuildOrder:
        return BuildOrder(
            ...
            Step(UnitExists(UnitTypeId.TWILIGHTCOUNCIL),
                 GridBuilding(unit_type=UnitTypeId.GATEWAY, to_count=8)),
    ...
    def counter_air(self) -> BuildOrder:
        return BuildOrder(
            ...
            ChronoUnit(UnitTypeId.PROBE, UnitTypeId.NEXUS, 3),

            Tech(UpgradeId.WARPGATERESEARCH),
            Tech(UpgradeId.BLINKTECH),
            Step(Supply(94),
                 GridBuilding(unit_type=UnitTypeId.ROBOTICSFACILITY, to_count=1, priority=True)),
            Step(UnitExists(UnitTypeId.GATEWAY, 5),
            ...
            # units
            Step(EnemyUnitExists(UnitTypeId.ADEPT, 2),
                 ProtossUnit(UnitTypeId.STALKER, priority=True, to_count=2)),
            Step(EnemyUnitExists(UnitTypeId.VOIDRAY),
    ...
    def pvt_micro_build(self) -> BuildOrder:
        return BuildOrder(
            ...
            BuildGas(2),
            GridBuilding(unit_type=UnitTypeId.STARGATE, to_count=1, priority=True),
            ProtossUnit(UnitTypeId.ORACLE, to_count=1, priority=True, only_once=True),
            ...
            # TODO couter attack
            ProtossUnit(UnitTypeId.SENTRY, priority=True, to_count=2),
            ...
            Step(EnemyUnitExists(UnitTypeId.MARAUDER, 4),
                 ProtossUnit(UnitTypeId.IMMORTAL, priority=True, to_count=2)),
            Step(EnemyUnitExists(UnitTypeId.MARAUDER, 1),
                 ProtossUnit(UnitTypeId.STALKER, priority=True)),
